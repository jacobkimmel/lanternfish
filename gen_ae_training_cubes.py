...
save_dir = '/media/jkimmel/HDD0/myctophid/ae_data'
...
# Load paths
rw_x = np.loadtxt('sim_data/rw_X_100k_mu5.csv', delimiter=',')
rw_y = np.loadtxt('sim_data/rw_Y_100k_mu5.csv', delimiter=',')
...
# Compress paths
rw_x = rw_x[:,:100] / fold_compression
rw_y = rw_y[:,:100] / fold_compression
pf_x = pf_x[:,:100] / fold_compression
pf_y = pf_y[:,:100] / fold_compression
fbm_x = fbm_x[:,:100] / fold_compression
fbm_y = fbm_y[:,:100] / fold_compression
